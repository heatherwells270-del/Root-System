...
- **Coalitions** — organize group projects: buying clubs, tool libraries, care pods, carpools
- **Knowledge Archive** — community-written guides, how-tos, and local know-how
- **Free Resources** — crisis lines, food assistance, legal aid, mental health support — always available, no sign-up required
...
3. "New Project" → import your fork → deploy

### Run Locally
```bash
git clone https://github.com/YOUR-USERNAME/root-system
cd root-system
npm install
npm run dev
---
...
- Posts are public by design — this is a community board.
- Data lives in shared browser storage. For larger communities, see `/docs/scaling.md`.
...
- **Community Covenant** — users affirm shared values before posting
- **Community flagging** — posts flagged by 3 members are automatically hidden
- **Appeals** — wrongly flagged posts can be restored by community vote
- **Trust scores** — visible on every post, transparent math
- **No internal messaging** — contact happens off-platform, reducing risk
- **Zip code only** — no precise location data
- **Crisis resources on every page** — ungated, always accessible
